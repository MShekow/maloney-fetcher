...
- [requests](https://github.com/psf/requests/), and [python-dateutil](https://pypi.org/project/python-dateutil/) to scrape DRS3's API for episode meta-data and download episodes
